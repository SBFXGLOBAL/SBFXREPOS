			...
			defaults: {
				...
				, onfocusin: function (element) {
					...
					if (this.settings.focusCleanup && !this.blockFocusCleanup) {
						this.settings.unhighlight && this.settings.unhighlight.call(this, element, this.settings.errorClass, this.settings
							.validClass);
			...
			prototype: {
				...
				defaultShowErrors: function () {
					for (var i = 0; this.errorList[i]; i++) {
						...
						this.settings.highlight && this.settings.highlight.call(this, error.element, this.settings.errorClass, this.settings
							.validClass);
